        ...
        <div class="center">
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
                <fieldset>
                    ...
                    <p>
                        <input type="text" name="name" placeholder="<?= _("name") ?>" value="<?= get_value('name') ?>" />
                    </p>
                    <p>
                        <input type="text" name="description" placeholder="<?= _("description") ?>" value="<?= get_value('description') ?>" />
                    </p>
                    <p>
                        <input type="text" name="price" placeholder="<?= _("price") ?>" value="<?= get_value('price') ?>" />
                    </p>
                    <p class="right">
